...
struct CommunityPost: Identifiable, Codable {
    ...
    let authorAvatar: String // System icon name
    let timestamp: Date
    let content: String
    ...
    var isAutoGenerated: Bool = false // New field to track auto-generated posts
    ...
    enum PostType: String, CaseIterable, Codable {
        ...
        var color: Color {
            switch self {
            case .help: return Color(red: 1.0, green: 0.0, blue: 0.0) // Red
            case .offer: return Color(red: 0.0, green: 0.8, blue: 0.0) // Green
            case .info: return Color(red: 0.0, green: 0.6, blue: 1.0) // Blue
            case .evacuation: return Color(red: 1.0, green: 0.5, blue: 0.0) // Orange
            case .shelter: return Color(red: 0.5, green: 0.0, blue: 1.0) // Purple
            case .resources: return Color(red: 1.0, green: 0.8, blue: 0.0) // Yellow
            }
        }
    }
...
struct CommunityThreadsView: View {
            ...
            .sheet(isPresented: $showPostDetail, onDismiss: {
                ...
                if let post = selectedPost {
                    PostDetailView(post: post) { action in
                        ...
                        // Update the selectedPost to reflect changes
                        if let index = posts.firstIndex(where: { $0.id == post.id }) {
                            selectedPost = posts[index]
                        }
                    } onCommentsUpdate: { updatedComments in
                        // Update the post's comments in the main array
                        if let index = posts.firstIndex(where: { $0.id == post.id }) {
    ...
    private func handlePostAction(_ action: PostAction, for post: CommunityPost) {
        ...
        case .comment:
            // Open comment view for this post
            selectedPost = post
            showPostDetail = true
        case .share:
            sharePost(post)
    ...
    private func refreshPosts() {
        refreshing = true
        // Simulate refresh by reloading posts
    ...
    private func createShareText(for post: CommunityPost) -> String {
        var shareText = "🔥 Wildfire Community Update\n\n"
        shareText += "📝 \(post.postType.rawValue)\n"
        shareText += "👤 \(post.authorName)\n"
        shareText += "🚨 Urgency: \(post.urgency.rawValue)\n"
        ...
        shareText += "❤️ Likes: \(post.likes)\n"
        
        shareText += "\n📱 Shared from Ignis - Wildfire Community App"
    ...
    private func loadPosts() {
        if let data = UserDefaults.standard.data(forKey: "communityPosts"),
           let decoded = try? JSONDecoder().decode([CommunityPost].self, from: data) {
            ...
            // Load sample posts if no saved data
            loadSamplePosts()
        }
    }
    ...
    private func loadSamplePosts() {
        posts = [
            // HELP NEEDED - Critical
            CommunityPost(
                authorName: "Sarah Johnson",
                authorAvatar: "person.crop.circle.fill",
                timestamp: Date().addingTimeInterval(-1800),
                content: "🚨 URGENT: Need help evacuating elderly parents from North County. Anyone with a vehicle available? We're near the evacuation zone and need assistance getting them to safety.",
                postType: .help,
            ...
            CommunityPost(
                ...
                content: "🏠 SHELTER UPDATE: Red Cross shelter now open at Central High School. Food, water, and medical assistance available. Pets welcome. Capacity: 200 people.",
                postType: .shelter,
            ...
            // OFFERING HELP - Medium
            CommunityPost(
                authorName: "David Martinez",
                authorAvatar: "person.crop.circle.badge.plus",
                timestamp: Date().addingTimeInterval(-5400),
                content: "💧 Offering free water and supplies to anyone in need. I have cases of water, masks, and first aid kits. Located at the community center parking lot.",
                postType: .offer,
            ...
            CommunityPost(
                ...
                content: "🔥 FIRE UPDATE: Containment at 45%. Winds shifting NW. New evacuation orders for Zone 3. Stay alert and follow official instructions.",
                postType: .info,
                location: "Zone 3",
                urgency: .high,
                likes: 234,
            ...
            CommunityPost(
                ...
                content: "🐕 Lost my dog during evacuation. Golden retriever named Max, last seen near Oak Street. He's friendly and wearing a red collar. Please help find him!",
                postType: .help,
                ...
                comments: [
                    ...
                    Comment(authorName: "Amanda Wilson", content: "FOUND HIM! Thank you everyone for your help! ❤️", timestamp: Date().addingTimeInterval(-300), likes: 45)
                ],
                isVerified: false,
                isLikedByUser: false
            ),
            ...
            CommunityPost(
                ...
                content: "💊 FREE MEDICATIONS: We have emergency supplies of inhalers, insulin, and other essential medications. No prescription needed during emergency. Open 24/7.",
                postType: .resources,
            ...
            CommunityPost(
                ...
                content: "🚨 MANDATORY EVACUATION: Zone 4 residents must evacuate immediately. Fire approaching rapidly. Take only essential items. Emergency shelters available.",
                postType: .evacuation,
                location: "Zone 4",
                urgency: .critical,
                likes: 445,
            ...
            CommunityPost(
                ...
                content: "💻 FREE TECH SUPPORT: Offering help with emergency communications, setting up alerts, and device charging. We have solar chargers and WiFi hotspots available.",
                postType: .offer,
            ...
            CommunityPost(
                ...
                content: "🐾 PET SHELTER: Temporary pet shelter open at County Fairgrounds. We have food, water, and kennels. Volunteers needed to help care for evacuated pets.",
                postType: .shelter,
            ...
            CommunityPost(
                ...
                content: "👴 NEED VOLUNTEERS: Looking for people to help transport elderly residents to shelters. Many need assistance with mobility and medical equipment.",
                postType: .help,
            ...
            CommunityPost(
                ...
                content: "🌤️ WEATHER UPDATE: Humidity levels dropping to 15%. Fire danger remains extreme. No rain expected for next 5 days. Stay hydrated and avoid outdoor activities.",
                postType: .info,
                location: "Regional",
                urgency: .low,
                likes: 156,
            ...
            CommunityPost(
                ...
                content: "🍎 FREE FOOD DISTRIBUTION: Fresh produce, canned goods, and ready-to-eat meals available. No ID required. Serving 500+ families daily. Volunteers welcome.",
                postType: .resources,
            ...
            CommunityPost(
                ...
                content: "🏗️ FREE CLEANUP SERVICES: Offering heavy equipment and labor for post-fire cleanup. Bulldozers, excavators, and dump trucks available. Contact for scheduling.",
                postType: .offer,
            ...
            CommunityPost(
                ...
                content: "📚 NEED SCHOOL SUPPLIES: Students displaced by fires need backpacks, notebooks, and basic supplies. Donations can be dropped off at temporary school location.",
                postType: .help,
            ...
            CommunityPost(
                ...
                content: "🧠 CRISIS COUNSELING: Free mental health support available for fire survivors. Trauma counselors, support groups, and 24/7 crisis hotline. You're not alone.",
                postType: .info,
    ...
    // MARK: - Auto-Post System
    
    private func setupAutoPostSystem() {
        // Load last auto-post date
        if let savedDate = UserDefaults.standard.object(forKey: "lastAutoPostDate") as? Date {
            lastAutoPostDate = savedDate
        } else {
            lastAutoPostDate = Date().addingTimeInterval(-86400) // Yesterday
        }
        
        // Check if we need to add new posts today
    ...
    private func checkAndAddDailyPosts() {
        ...
        // Check if we already added posts today
    ...
    private func addDailyAutoPosts(count: Int) {
        ...
        print("📅 Added \(count) new auto-generated posts for today")
    }
    ...
    private func getDailyPostTemplates() -> [DailyPostTemplate] {
        return [
            ...
            DailyPostTemplate(
                ...
                authorAvatar: "person.crop.circle.badge.questionmark",
                content: "🚨 Need help with elderly neighbor evacuation. Anyone available to assist? She has mobility issues and needs help getting to the shelter.",
                postType: .help,
                location: "Oak Street Area",
                urgency: .high,
                isVerified: false
            ...
            DailyPostTemplate(
                ...
                authorAvatar: "pawprint.circle.fill",
                content: "🐕 Lost my dog during evacuation. Golden retriever named Buddy, last seen near Main Street. He's friendly and wearing a blue collar. Please help!",
                postType: .help,
            ...
            DailyPostTemplate(
                ...
                authorAvatar: "person.crop.circle.badge.plus",
                content: "💧 Offering free water and supplies to anyone in need. I have cases of water, masks, and first aid kits. Located at the community center.",
                postType: .offer,
                location: "Community Center",
                urgency: .medium,
                isVerified: false
            ...
            DailyPostTemplate(
                ...
                content: "🏠 FREE SHELTER: Our hotel has 20 rooms available for evacuees. Free WiFi, meals included. Contact front desk for arrangements.",
                postType: .offer,
            ...
            DailyPostTemplate(
                authorName: "Weather Service",
                authorAvatar: "cloud.sun.rain.fill",
                content: "🌤️ WEATHER UPDATE: Humidity at 25%. Fire danger remains high. Winds expected to shift NW by evening. Stay alert.",
                postType: .info,
                location: "Regional",
                urgency: .medium,
                isVerified: true
            ...
            DailyPostTemplate(
                authorName: "Fire Department",
                authorAvatar: "flame.circle.fill",
                content: "🔥 FIRE UPDATE: Containment at 60%. New evacuation orders for Zone 2. Fire crews making good progress.",
                postType: .info,
                location: "Zone 2",
                urgency: .high,
                isVerified: true
            ...
            DailyPostTemplate(
                ...
                authorAvatar: "cross.fill",
                content: "🏠 SHELTER UPDATE: Red Cross shelter open at Central High School. Food, water, medical assistance available. Pets welcome.",
                postType: .shelter,
                location: "Central High School",
                urgency: .high,
                isVerified: true
            ...
            DailyPostTemplate(
                authorName: "Animal Shelter",
                authorAvatar: "pawprint.circle.fill",
                content: "🐾 PET SHELTER: Temporary pet shelter open at County Fairgrounds. Food, water, and kennels available. Volunteers needed.",
                postType: .shelter,
                location: "County Fairgrounds",
                urgency: .medium,
                isVerified: true
            ...
            DailyPostTemplate(
                authorName: "Community Pharmacy",
                authorAvatar: "pills.fill",
                content: "💊 FREE MEDICATIONS: Emergency supplies of inhalers, insulin, and essential medications available. No prescription needed during emergency.",
                postType: .resources,
                location: "Downtown Pharmacy",
                urgency: .medium,
                isVerified: true
            ...
            DailyPostTemplate(
                authorName: "Food Bank",
                authorAvatar: "cart.circle.fill",
                content: "🍎 FREE FOOD DISTRIBUTION: Fresh produce, canned goods, and ready-to-eat meals available. No ID required. Serving 300+ families daily.",
                postType: .resources,
                location: "Community Food Bank",
                urgency: .high,
                isVerified: true
            ...
            DailyPostTemplate(
                authorName: "Emergency Services",
                authorAvatar: "exclamationmark.octagon.fill",
                content: "🚨 MANDATORY EVACUATION: Zone 3 residents must evacuate immediately. Fire approaching rapidly. Take only essential items.",
                postType: .evacuation,
                location: "Zone 3",
                urgency: .critical,
                isVerified: true
    ...
    private func createPostFromTemplate(_ template: DailyPostTemplate) -> CommunityPost {
        ...
        // Randomize likes (5-50 for auto-generated posts)
        ...
        // Add seasonal variations to content
...
struct ThreadCard: View {
    ...
    private var cleanedContent: String {
        // Remove excessive emojis and clean up verbose content
        return post.content
            .replacingOccurrences(of: "🚨 URGENT:", with: "")
            .replacingOccurrences(of: "🚨 MANDATORY EVACUATION:", with: "EVACUATION:")
            .replacingOccurrences(of: "🏠 SHELTER UPDATE:", with: "")
            .replacingOccurrences(of: "💧 Offering", with: "Offering")
            .replacingOccurrences(of: "🔥 FIRE UPDATE:", with: "")
            .replacingOccurrences(of: "🌤️ WEATHER UPDATE:", with: "")
            .replacingOccurrences(of: "💊 FREE MEDICATIONS:", with: "Free medications:")
            .replacingOccurrences(of: "🍎 FREE FOOD DISTRIBUTION:", with: "Free food:")
...
struct CommentRow: View {
    ...
    private func shareComment(_ comment: Comment) {
        let shareText = "💬 \(comment.authorName): \(comment.content)\n\n📱 Shared from Ignis - Wildfire Community App"
...
struct PostDetailView: View {
                    ...
                    VStack(spacing: 20) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            HStack(spacing: 20) {
                                ...
                                Button(action: { 
                                    // Comment button is just for show since we're already in comment view
                                }) {
                                    HStack(spacing: 4) {
    ...
    private func updatePostComments() {
        // Notify parent view of comment updates
        onCommentsUpdate(comments)
    }
    
    private func sharePostFromDetail(_ post: CommunityPost) {
        // Create shareable text content with comments
